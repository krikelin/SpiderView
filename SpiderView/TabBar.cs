    ...
    public partial class TabBar : UserControl
    {
        ...
        void TabBar_MouseClick(object sender, MouseEventArgs e)
        {
            if (Titles != null)
            {
                ...
                {
                    strW += this.Block.Stylesheet.MeasureString(Graphics, l.Title, new System.Drawing.Font("MS Sans Serif", 8.0f, FontStyle.Bold), true).Width * 1.1f;

                }
                float left = this.Width - strW - 24;
                foreach (Link l in Titles)
                {
                    float xx = this.Block.Stylesheet.MeasureString(Graphics, l.Title, new System.Drawing.Font("MS Sans Serif", 8.0f, FontStyle.Bold), true).Width * 1.1f;
        ...
        void TabBar_MouseMove(object sender, MouseEventArgs e)
        {
            if (Titles != null)
            {
                ...
                foreach (Link l in Titles)
                {
                    strW += this.Block.Stylesheet.MeasureString(Graphics, l.Title, TitleBlock.Font, true).Width * 1.1f;
                ...
                foreach (Link l in Titles)
                {
                    float xx = this.Block.Stylesheet.MeasureString(Graphics, l.Title, TitleBlock.Font, true).Width * 1.1f;
                    if (e.X > left && e.X < left + xx)
                    {
                        foundLink = true;
                    }
        ...
        public void Draw(Graphics g)
        {
            try
            {
                ...
                foreach (Tab tab in Tabs)
                {
                    ...
                    float strWidth = this.Block.Stylesheet.MeasureString(g, tab.Title, new Font("MS Sans Serif", 8), true).Width;
                    float left = x + ((float)tab.Width / 2.0f) - (strWidth / 2.0f);
                    this.Block.Stylesheet.DrawString(graphics.Graphics, tab.Title, new Font("MS Sans Serif", 8), new SolidBrush(Block.TextShadowColor), new Rectangle((int)left, 3, 320, 50), true);
                    this.Block.Stylesheet.DrawString(graphics.Graphics, tab.Title, new Font("MS Sans Serif", 8), new SolidBrush(Block.ForeColor), new Rectangle((int)left, 4, 320, 50), true);
                ...
                if (Titles != null)
                {
                    ...
                    foreach (Link l in Titles)
                    {
                        strW += this.Block.Stylesheet.MeasureString(g, l.Title, TitleBlock.Font, true).Width * 1.1f;
                    ...
                    foreach (Link l in Titles)
                    {
                        float xx = this.Block.Stylesheet.MeasureString(g, l.Title, TitleBlock.Font, true).Width * 1.1f;
                        this.Block.Stylesheet.DrawString(graphics.Graphics, l.Title, TitleBlock.Font, new SolidBrush(Color.Black), new Rectangle((int)left, 5, (int)xx, 18), true);
                        this.Block.Stylesheet.DrawString(graphics.Graphics, l.Title, TitleBlock.Font, new SolidBrush(Color.White), new Rectangle((int)left, 4, (int)xx, 18), true);
                        left += xx;
                        if( i < Titles.Count -1)
                            this.Block.Stylesheet.DrawString(graphics.Graphics, "»", TitleBlock.Font, new SolidBrush(TitleBlock.AlternateForeColor), new Rectangle((int)left, 4, (int)20, 18), true);
